...
int main() {
  ...
  // Problema: Deseja-se converter uma medida de temperatura da escala Celsius
  // para Fahrenheit ou vice-versa. Para isso, você deveconstruir um programa
  // que leia a letra C ou F; indicando em qual escala vai ser informada uma
